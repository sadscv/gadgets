...
from TW_Homework_drone.drone import Drone
...
class TestDrone(unittest.TestCase):
    ...
    def test_readfile(self):
        ...
        path2 = 'testcase/wrongpath.txt'

        drone = Drone()
        self.assertEqual(drone.readfile(path0), True)
        self.assertEqual(drone.readfile(path1), False)
        with self.assertRaises(FileNotFoundError):
            drone.readfile(path2)
